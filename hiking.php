...
<body>
  ...
  <nav class="navbar navbar-expand-md bg-dark navbar-dark">
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="http://localhost/project/hiking.php"><i class="fas fa-th-list mr-2"></i>Hiking</a>
        </li>
        <li class="nav-item">
        ...
        <center><h2>Hiking Items</h2></center>
  ...
  <div class="container">
    ...
    <div class="row mt-2 pb-3">
      <?php
        include 'config.php';
        $stmt = $conn->prepare('SELECT * FROM product where category="H"');
        $stmt->execute();
